...
Some companies started ICOs creating new blockchains or new tokens on the ethereum blockchain.
...
Ethereum is the most well-known open-source Bitcoin successor.  
It was developed by Vitalik Buterin in 2013 and its main client is written in Go.
...
This standard is the most common for creating new tokens and is tipically used in Initial Coin Offerings (ICOs)
...
As the notion of DAOs evolves, we may also have DACs, Decentralized Autonomous Corporations, with the primary distinction being that while DAOs are nonprofit, DACs can generate a profit through shares given to participants and to whom they can pay dividends.  
...
We briefly mentioned DeFi previously, stating that it includes all the applications that provide financial services in a decentralized manner without the need of a trusted third party.  

Let's dive deep into analyzing the five pillars of decentralized finance

The first one are Stablecoins.
They are cryptocurrency that match real world assets.  
...
Two more forms of decentralized applications that can be found in the wild are decentralized gaming apps and NFT markets.

Let me give you an example.

Cryptokitties is a platform that encompasses both of these categories.  
Cryptokitties is a game that allows you to raise kittens that are technically NFTs and can be traded on corresponding marketplaces.  
These cats have some form of stats and related rarity, which increases their worth.  
You may raise your cat NFT and sell it for money, or you can rent your cat for breeding as a way to earn money passively.  
These cats have risen in value: in September 2018, a Dragon cat was auctioned for $171,000 USD.  
...
Decentraland and Sandbox are two important references in this scenario.
Both offer a virtual world in which users can purchase terrain, build on top of it, and create brand new assets using an integrated editor.
